	...
	$(window).on('load', function() {
		...
		$('form').on('submit', function (e) {
	        ...
	        if (e.isDefaultPrevented()) {
	            ...
	            theForm.find('.form-preloader').fadeIn();
	            theForm.find('.loader').fadeIn(0);
	            ...
	            $.ajax({
	                ...
	                setTimeout(function(){
	                    theForm.closest('.modal').modal('toggle');
	                    theForm.find('.form-preloader').fadeOut();
